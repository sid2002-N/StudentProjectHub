...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 left-0 right-0 z-50 backdrop-blur-md bg-black/25 border-b border-[hsl(174,100%,50%)]/20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <NavLink href="/projects" currentPath={location}>PROJECTS</NavLink>
          ...
          <div className="md:hidden">
            <Sheet open={isOpen} onOpenChange={handleSheetOpen}>
              <SheetTrigger asChild>
                <Button variant="ghost" size="icon" className="text-[hsl(174,100%,50%)]">
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="pt-6 mt-6 border-t border-gray-700">
                    <div className="flex space-x-4 justify-center">
                      ...
                      <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[hsl(174,100%,50%)] transition-colors">
                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
