...
export const projects: Project[] = [
  {
    ...
    shortDescription: "Complete e-commerce solution with admin dashboard, payment processing, and inventory management.",
    description: "A comprehensive full stack e-commerce platform built using MERN stack (MongoDB, Express, React, Node.js) with complete features including user authentication, product management, shopping cart, payment processing, and admin dashboard.",
    categories: ['web'],
    tech: ["React", "Node.js", "Express", "MongoDB", "Redux", "Stripe API", "JWT"],
    features: [
