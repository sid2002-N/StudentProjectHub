      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <PriceCard 
            title="Mini Projects"
            price="₹***"
            description="Quick assistance for small tasks"
            features={[
        ...
        <div className="max-w-3xl mx-auto mt-16 backdrop-blur-md bg-zinc-900/25 p-8 rounded-lg border border-white/5">
          ...
          <div className="flex justify-center">
            <Link href="/contact">
              <div className="relative px-8 py-3 bg-zinc-800 text-[hsl(174,100%,50%)] font-cyber uppercase tracking-wider hover:bg-zinc-700 transition duration-300 border border-[hsl(174,100%,50%)]/50 shadow-[0_0_5px_rgba(12,255,225,0.5),inset_0_0_5px_rgba(12,255,225,0.2)] rounded">
