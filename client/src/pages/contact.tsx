            ...
            <div className="md:col-span-2 space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="mailto:contact@techprojects.dev" className="text-[hsl(300,100%,50%)] hover:text-white transition">contact@techprojects.dev</a>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="text-[hsl(300,100%,50%)] mr-4">
                    ...
                    <div>
                      ...
                      <a href="https://wa.me/1234567890" className="text-[hsl(300,100%,50%)] hover:text-white transition">+1 (234) 567-890</a>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="text-[hsl(300,100%,50%)] mr-4">
              ...
              <div className="backdrop-blur-md bg-zinc-900/25 p-6 rounded-lg border border-[hsl(60,100%,50%)]/50 shadow-[0_0_5px_rgba(255,255,0,0.5),inset_0_0_5px_rgba(255,255,0,0.2)]">
                ...
                <div className="flex space-x-4">
                  <a href="https://github.com/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[hsl(60,100%,50%)] transition-colors p-2">
                  ...
                  <a href="https://linkedin.com/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[hsl(60,100%,50%)] transition-colors p-2">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"></path>
                    </svg>
                  </a>
                  <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[hsl(60,100%,50%)] transition-colors p-2">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
